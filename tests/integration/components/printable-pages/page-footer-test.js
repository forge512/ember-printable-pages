...
module("Integration | Component | printable-pages/page-footer", function (hooks) {
  ...
  test("single-page single-chapter document - has expected page meta info", async function (assert) {
    ...
    assert.dom("[data-test-chapter] [data-test-page-footer]").exists({ count: 1 });
  ...
  test("multi-page single-chapter document - has expected page meta info", async function (assert) {
    ...
    assert.dom("[data-test-chapter] [data-test-page-footer]").exists({ count: 2 });

    // Chapter 1 Page 1
    assert.dom("[data-test-page='1'] [data-test-footer-chapter-number]").hasText("1");
    assert.dom("[data-test-page='1'] [data-test-footer-page-number]").hasText("1");
    assert.dom("[data-test-page='1'] [data-test-footer-is-first]").hasText("true");
    assert.dom("[data-test-page='1'] [data-test-footer-is-first-in-chapter]").hasText("true");
    assert.dom("[data-test-page='1'] [data-test-footer-is-last]").hasText("false");
    assert.dom("[data-test-page='1'] [data-test-footer-is-last-in-chapter]").hasText("false");
    assert.dom("[data-test-page='1'] [data-test-footer-total]").hasText("2");

    // Chapter 1 Page 2
    assert.dom("[data-test-page='2'] [data-test-footer-chapter-number]").hasText("1");
    assert.dom("[data-test-page='2'] [data-test-footer-page-number]").hasText("2");
    assert.dom("[data-test-page='2'] [data-test-footer-is-first]").hasText("false");
    assert.dom("[data-test-page='2'] [data-test-footer-is-first-in-chapter]").hasText("false");
    assert.dom("[data-test-page='2'] [data-test-footer-is-last]").hasText("true");
    assert.dom("[data-test-page='2'] [data-test-footer-is-last-in-chapter]").hasText("true");
  ...
  test("single-page multi-chapter document - has expected page meta info", async function (assert) {
    ...
    assert.dom("[data-test-page='1'] [data-test-footer-is-first-in-chapter]").hasText("true");
    assert.dom("[data-test-page='1'] [data-test-footer-is-last]").hasText("false");
    assert.dom("[data-test-page='1'] [data-test-footer-is-last-in-chapter]").hasText("true");
    assert.dom("[data-test-page='1'] [data-test-footer-total]").hasText("2");

    assert.dom("[data-test-page='2'] [data-test-footer-chapter-number]").hasText("2");
    assert.dom("[data-test-page='2'] [data-test-footer-page-number]").hasText("2");
    assert.dom("[data-test-page='2'] [data-test-footer-is-first]").hasText("false");
    assert.dom("[data-test-page='2'] [data-test-footer-is-first-in-chapter]").hasText("true");
    assert.dom("[data-test-page='2'] [data-test-footer-is-last]").hasText("true");
    assert.dom("[data-test-page='2'] [data-test-footer-is-last-in-chapter]").hasText("true");
    assert.dom("[data-test-page='2'] [data-test-footer-total]").hasText("2");
  });
  ...
  test("multi-page multi-chapter document - has expected page meta info", async function (assert) {
    ...
    assert.dom("[data-test-chapter] [data-test-page-footer]").exists({ count: 4 });
    ...
    assert.dom("[data-test-page='2'] [data-test-footer-is-first]").hasText("false");
    assert.dom("[data-test-page='2'] [data-test-footer-is-first-in-chapter]").hasText("false");
    assert.dom("[data-test-page='2'] [data-test-footer-is-last]").hasText("false");
    assert.dom("[data-test-page='2'] [data-test-footer-is-last-in-chapter]").hasText("true");
    assert.dom("[data-test-page='2'] [data-test-footer-total]").hasText("4");

    // Chapter 2 Page 1
    assert.dom("[data-test-page='3'] [data-test-footer-chapter-number]").hasText("2");
    assert.dom("[data-test-page='3'] [data-test-footer-page-number]").hasText("3");
    assert.dom("[data-test-page='3'] [data-test-footer-is-first]").hasText("false");
    assert.dom("[data-test-page='3'] [data-test-footer-is-first-in-chapter]").hasText("true");
    assert.dom("[data-test-page='3'] [data-test-footer-is-last]").hasText("false");
    assert.dom("[data-test-page='3'] [data-test-footer-is-last-in-chapter]").hasText("false");
    assert.dom("[data-test-page='3'] [data-test-footer-total]").hasText("4");

    // Chapter 2 Page 2
    assert.dom("[data-test-page='4'] [data-test-footer-chapter-number]").hasText("2");
    assert.dom("[data-test-page='4'] [data-test-footer-page-number]").hasText("4");
    assert.dom("[data-test-page='4'] [data-test-footer-is-first]").hasText("false");
    assert.dom("[data-test-page='4'] [data-test-footer-is-first-in-chapter]").hasText("false");
    assert.dom("[data-test-page='4'] [data-test-footer-is-last]").hasText("true");
    assert.dom("[data-test-page='4'] [data-test-footer-is-last-in-chapter]").hasText("true");
